...
public class Chicken_Attack : Boss_Skill
{
    [SerializeField] GameObject Main;
    [SerializeField] OstrichChicken ostrichChicken;
    ...
    private void Update()
    {
        ...
        {
            TurnOff();
            AttackHit = ostrichChicken.GetAttack_Hit();
            if (AttackHit != null)
            {
                AttackHit.transform.position = transform.position;
                AttackHit.GetComponent<Chicken_Attack_Hit>().SetUp(Damage);
